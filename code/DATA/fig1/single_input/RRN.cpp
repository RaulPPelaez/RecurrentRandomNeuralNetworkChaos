...
public:
  ...
  void train_network(TRAINING_MODE mode){
	...
	input_pattern[i] = sp.input_pulse_value/20.0f;
    }
	...
	else if(step==sp.end_train-1) training = false;
...
int main(int argc, char* argv[]){
  ...
  cerr<<sp.end_train<<endl;
  sp.nsteps = int((sp.end_train+5000)/sp.dt);
  sp.nloops    = 1;
